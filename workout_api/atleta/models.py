...
class AtletaModel(BaseModel):
    ...
    created_at: Mapped[datetime] = mapped_column(DateTime,
                                                 nullable=False)
    categoria: Mapped["CategoriaModel"] = relationship(  # type: ignore[name-defined]
                                             back_populates="atleta",
                                             lazy="selectin")
    categoria_id: Mapped[int] = mapped_column(
                                    ForeignKey("categorias.pk_id"))
    centro_treinamento: Mapped["CentroTreinamentoModel"] = relationship(  # type: ignore[name-defined]
                                             back_populates="atleta",
                                             lazy="selectin")
